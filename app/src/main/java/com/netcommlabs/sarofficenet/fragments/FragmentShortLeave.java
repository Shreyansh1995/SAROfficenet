 ...
 */
public class FragmentShortLeave extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_short_leave, container, false);
    ...
    public void onClick(View view) {
        ...
        switch (id){
            case R.id.ll_newreq:
                ...
                intent1.putExtra("frag_name", "FragmentShortLeaveTab");
                intent1.putExtra("frag_tag", "newrequest");
                intent1.putExtra("title", "Short Leave");
            ...
            case R.id.ll_archivereq:
                ...
                intentarchive.putExtra("frag_name", "FragmentShortLeaveTab");
                intentarchive.putExtra("frag_tag", "newrequest");
                intentarchive.putExtra("title", "Short Leave");
