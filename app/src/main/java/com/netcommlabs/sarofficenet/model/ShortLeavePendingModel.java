...
public class ShortLeavePendingModel {
    ...
    public ShortLeavePendingModel(String empName, String HODStatus, String leaveDate, String period, String RMstatus, String reqDate, String reqID, String reqNo, String type) {
        EmpName = empName;
