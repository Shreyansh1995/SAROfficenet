...
import com.netcommlabs.sarofficenet.adapter.LeavePendingListAdapter;
 ...
 */
public class FragmentLeaveCanceled extends Fragment implements ResponseListener, View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewMain = inflater.inflate(R.layout.fragment_leave_canceled, container, false);
    ...
    private void hitApiForLeaveDetails() {
        try {
            request = new ProjectWebRequest(getContext(), getParamForLeaveDetails(), UrlConstants.LEAVE_USER_CANCEL_DEATILS, this, UrlConstants.LEAVE_USER_CANCEL_DEATILS_TAG);
            request.execute();
        } catch (Exception e) {
            clearRef();
            e.printStackTrace();
    ...
    public void onSuccess(JSONObject obj, int Tag) {
        ...
        if (obj.optString("Status").equals("true")) {
            ...
            if (Tag == UrlConstants.LEAVE_USER_CANCEL_DEATILS_TAG) {
                ...
                try {
                    ...
                    lv_details.setAdapter(new LeavePendingListAdapter(getActivity(), leaveListModelArrayList));
                } catch (Exception e) {
                }
            }
        } else {
