...
public class FragmentLeaveArchive extends Fragment implements ResponseListener, View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewMain = inflater.inflate(R.layout.fragment_leave_archive, container, false);
    ...
    private void hitApiForLeaveDetails() {
        try {
            request = new ProjectWebRequest(getContext(), getParamForLeaveDetails(), UrlConstants.LEAVE_ARCHIVE_LIST, this, UrlConstants.LEAVE_ARCHIVE_LIST_TAG);
            request.execute();
        } catch (Exception e) {
            clearRef();
            e.printStackTrace();
    ...
    public void onSuccess(JSONObject obj, int Tag) {
        ...
        if (obj.optString("Status").equals("true")) {
            ...
            if (Tag == UrlConstants.LEAVE_ARCHIVE_LIST_TAG) {
