...
public class ShortLeaveModel {
    ...
    public ShortLeaveModel(String empName, String HODStatus, String leaveDate, String period, String RMstatus, String reqDate, String reqID, String reqNo, String type) {
        EmpName = empName;
